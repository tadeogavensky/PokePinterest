...
const Card = ({ pokemon }) => {
  ...
  return (
    <Link
      ...
      className="w-full shadow-lg h-[120px] max-xs:h-[200px] rounded-2xl py-4 px-3 flex max-xs:flex-col max-xs:items-center justify-between gap-4 relative overflow-hidden"
      style={{
        backgroundColor,
      }}
    >
      ...
      {loading ? (
        ...
        <img
          ...
          className="w-[45%] max-xs:w-[70%] h-auto z-10 "
          alt={pokemon.name}
        />
      )}
    </Link>
