...
import MonthCard from "../pokedex/MonthCard";
...
const Home = () => {
  ...
  const { pokemons,randomPokemon } = useContext(PokemonContext);
  ...
  return (
    <div className="min-h-screen flex flex-col relative px-8 pt-12 overflow-hidden">
      ...
      <div className="flex flex-col justify-start items-start mt-8 gap-2">
          <h1 className="font-body text-2xl text-gray-700 font-extrabold">Our Pokemon of the month</h1>
          
          <MonthCard pokemon={randomPokemon}/>
      </div>
